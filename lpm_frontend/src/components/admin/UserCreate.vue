                ...
                <div class="flex flex-col gap-4 px-4">
                    ...
                    <div class="flex flex-col gap-1">
                        ...
                        <div class="flex items-center divide-x-[1px] divide-black gap-2 pl-2 border border-black rounded bg-neutral-300">
                            ...
                            <select v-model="form.id_roles" name="role" id="role" class="p-2 w-full focus:outline-none capitalize">
                    ...
                    <div v-if="form.id_roles === 2" class="flex flex-col gap-1">
                        ...
                        <div class="flex items-center divide-x-[1px] divide-black gap-2 pl-2 border border-black rounded bg-neutral-300">
                            ...
                            <select v-model="form.id_fakultas" name="fakultas"
                                    id="fakultas" class="p-2 w-full focus:outline-none">
                                <option v-for="fakultas in tb_fakultas" :key="fakultas.id" :value="fakultas.id">
                                    {{ fakultas.fakultas }} - {{ fakultas.prodi}}
                                </option>
                            </select>
                        </div>
                    </div>
...
const roles = ref([]);
document.title = `Create User | ${authStore.name}`;
